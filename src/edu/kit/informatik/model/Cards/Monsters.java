...
import edu.kit.informatik.model.Cards.abilities.*;
...
public enum Monsters {
     ...
     * The Frog.
     */
    FROG(1, 16, List.of(MonsterType.WATER), List.of(new Focus(1), new Water(1))),
    /**
     * The Ghost.
     */
    GHOST(1, 15, List.of(MonsterType.ICE), List.of(new Focus(1), new Water(1))),
    /**
     * The Gorgon.
     */
    GORGON(1, 1, List.of(MonsterType.FIRE), List.of(new Focus(1), new Fire(1))),
    /**
     * The Skeleton.
     */
    SKELETON(1, 1, List.of(MonsterType.LIGHTNING), List.of(new Focus(1), new Lightning(1))),
    /**
     * The Spider.
     */
     ...
     * The Dark elf.
     */
    DARK_ELF(2, 1, List.of(), List.of(new Focus(2), new Water(1), new Lightning(1))),
    /**
     * The Shadow blade.
     */
